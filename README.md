...
> **README gerado automaticamente em: 2026-05-22 06:22 UTC**
...
| Capítulos traduzidos | **2,263** (59.1%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$90 USD** |
| ETA estimado de processamento | **~2d 12h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-22 06:22 UTC |
...
| 🏔️ Armênio Oriental | Armênio Clássico | 260 caps | 11 traduzidos | 🚀 Em andamento (4%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 2,263/3,826 caps (59.1%))
