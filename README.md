...
> **README gerado automaticamente em: 2026-05-19 06:50 UTC**
...
| Capítulos traduzidos | **215** (1.8%) |
| ETA estimado de processamento | **~18d 14h** |
| Custo estimado restante (Oracle GPU) | **~$669 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 06:50 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 215 traduzidos | 🚀 Em andamento (23%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 215/11,815 caps (1.8%))
