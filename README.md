...
> **README gerado automaticamente em: 2026-05-21 17:24 UTC**
...
| Capítulos traduzidos | **1,931** (50.5%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$109 USD** |
| ETA estimado de processamento | **~3d 0h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-21 17:24 UTC |
...
| 📖 Peshitta Siríaca | Siríaco Clássico | 260 caps | 199 traduzidos | 🚀 Em andamento (77%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,931/3,826 caps (50.5%))
