...
> **README gerado automaticamente em: 2026-05-18 23:43 UTC**
...
| Capítulos traduzidos | **62** (1.4%) |
| ETA estimado | **~12d 6h** |
| Velocidade (com Double-Pass) | ~15 caps/hora |
| Última atualização | 2026-05-18 23:43 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 62 traduzidos | 🚀 Em andamento (7%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 62/4,475 caps (1.4%))
