...
> **README gerado automaticamente em: 2026-05-20 21:34 UTC**
...
| Capítulos traduzidos | **1,382** (36.7%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$137 USD** |
| ETA estimado de processamento | **~3d 19h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 21:34 UTC |
...
| 🇪🇹 Ge'ez (Etiópico) | Ge'ez Clássico | 296 caps | 65 traduzidos | 🚀 Em andamento (22%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,382/3,768 caps (36.7%))
