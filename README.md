...
> **README gerado automaticamente em: 2026-05-19 11:43 UTC**
...
| Capítulos traduzidos | **345** (2.9%) |
| ETA estimado de processamento | **~18d 9h** |
| Custo estimado restante (Oracle GPU) | **~$661 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 11:43 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 345 traduzidos | 🚀 Em andamento (37%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 345/11,815 caps (2.9%))
