...
> **README gerado automaticamente em: 2026-05-20 04:05 UTC**
...
| Capítulos traduzidos | **902** (18.1%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$235 USD** |
| ETA estimado de processamento | **~6d 13h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 04:05 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 902 traduzidos | 🚀 Em andamento (97%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 902/4,990 caps (18.1%))
