...
> **README gerado automaticamente em: 2026-05-18 23:23 UTC**
...
| Capítulos traduzidos | **53** (1.2%) |
| ETA estimado | **~12d 6h** |
| Velocidade (com Double-Pass) | ~15 caps/hora |
| Última atualização | 2026-05-18 23:23 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 53 traduzidos | 🚀 Em andamento (6%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 53/4,475 caps (1.2%))
