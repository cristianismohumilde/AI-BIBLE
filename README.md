...
> **README gerado automaticamente em: 2026-05-18 23:18 UTC**
...
| Capítulos traduzidos | **51** (1.1%) |
| ETA estimado | **~12d 6h** |
| Velocidade (com Double-Pass) | ~15 caps/hora |
| Última atualização | 2026-05-18 23:18 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 51 traduzidos | 🚀 Em andamento (5%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 51/4,475 caps (1.1%))
