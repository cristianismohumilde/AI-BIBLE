...
> **README gerado automaticamente em: 2026-05-21 21:42 UTC**
...
| Capítulos traduzidos | **2,042** (53.4%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$102 USD** |
| ETA estimado de processamento | **~2d 20h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-21 21:42 UTC |
...
| 🔤 Copta Saídico | Copta Saídico | 260 caps | 50 traduzidos | 🚀 Em andamento (19%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 2,042/3,826 caps (53.4%))
