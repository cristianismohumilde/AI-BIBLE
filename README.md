...
> **README gerado automaticamente em: 2026-05-20 23:40 UTC**
...
| Capítulos traduzidos | **1,438** (38.2%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$134 USD** |
| ETA estimado de processamento | **~3d 17h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 23:40 UTC |
...
| 🇪🇹 Ge'ez (Etiópico) | Ge'ez Clássico | 296 caps | 121 traduzidos | 🚀 Em andamento (41%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,438/3,768 caps (38.2%))
