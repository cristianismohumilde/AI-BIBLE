...
> **README gerado automaticamente em: 2026-05-21 16:03 UTC**
...
| Capítulos traduzidos | **1,879** (49.1%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$112 USD** |
| ETA estimado de processamento | **~3d 2h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-21 16:03 UTC |
...
| 📖 Peshitta Siríaca | Siríaco Clássico | 260 caps | 147 traduzidos | 🚀 Em andamento (57%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,879/3,826 caps (49.1%))
