...
> **README gerado automaticamente em: 2026-05-20 00:29 UTC**
...
| Capítulos traduzidos | **711** (14.2%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$246 USD** |
| ETA estimado de processamento | **~6d 20h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 00:29 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 711 traduzidos | 🚀 Em andamento (77%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 711/4,990 caps (14.2%))
