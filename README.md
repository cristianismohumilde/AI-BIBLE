...
> **README gerado automaticamente em: 2026-05-19 10:17 UTC**
...
| Capítulos traduzidos | **310** (2.6%) |
| ETA estimado de processamento | **~18d 10h** |
| Custo estimado restante (Oracle GPU) | **~$663 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 10:17 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 310 traduzidos | 🚀 Em andamento (33%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 310/11,815 caps (2.6%))
