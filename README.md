...
> **README gerado automaticamente em: 2026-05-19 07:46 UTC**
...
| Capítulos traduzidos | **246** (2.1%) |
| ETA estimado de processamento | **~18d 12h** |
| Custo estimado restante (Oracle GPU) | **~$667 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 07:46 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 246 traduzidos | 🚀 Em andamento (27%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 246/11,815 caps (2.1%))
