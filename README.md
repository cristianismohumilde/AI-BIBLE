...
> **README gerado automaticamente em: 2026-05-22 03:00 UTC**
...
| Capítulos traduzidos | **2,155** (56.3%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$96 USD** |
| ETA estimado de processamento | **~2d 16h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-22 03:00 UTC |
...
| 🔤 Copta Saídico | Copta Saídico | 260 caps | 163 traduzidos | 🚀 Em andamento (63%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 2,155/3,826 caps (56.3%))
