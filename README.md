...
> **README gerado automaticamente em: 2026-05-20 18:17 UTC**
...
| Capítulos traduzidos | **1,286** (34.1%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$143 USD** |
| ETA estimado de processamento | **~3d 23h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 18:17 UTC |
...
| 🏛️ Septuaginta (LXX) | Grego Clássico | 389 caps | 358 traduzidos | 🚀 Em andamento (92%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,286/3,768 caps (34.1%))
