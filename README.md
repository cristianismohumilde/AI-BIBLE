...
> **README gerado automaticamente em: 2026-05-19 11:17 UTC**
...
| Capítulos traduzidos | **334** (2.8%) |
| ETA estimado de processamento | **~18d 9h** |
| Custo estimado restante (Oracle GPU) | **~$662 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 11:17 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 334 traduzidos | 🚀 Em andamento (36%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 334/11,815 caps (2.8%))
