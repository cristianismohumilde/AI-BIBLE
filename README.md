...
> **README gerado automaticamente em: 2026-05-20 15:26 UTC**
...
| Capítulos traduzidos | **1,187** (31.5%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$148 USD** |
| ETA estimado de processamento | **~4d 3h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 15:26 UTC |
...
| 🏛️ Septuaginta (LXX) | Grego Clássico | 389 caps | 259 traduzidos | 🚀 Em andamento (67%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,187/3,768 caps (31.5%))
