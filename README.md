...
> **README gerado automaticamente em: 2026-05-19 07:26 UTC**
...
| Capítulos traduzidos | **234** (2.0%) |
| ETA estimado de processamento | **~18d 13h** |
| Custo estimado restante (Oracle GPU) | **~$668 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 07:26 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 234 traduzidos | 🚀 Em andamento (25%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 234/11,815 caps (2.0%))
