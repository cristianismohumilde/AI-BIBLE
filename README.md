...
> **README gerado automaticamente em: 2026-05-19 07:36 UTC**
...
| Capítulos traduzidos | **240** (2.0%) |
| ETA estimado de processamento | **~18d 13h** |
| Custo estimado restante (Oracle GPU) | **~$667 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 07:36 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 240 traduzidos | 🚀 Em andamento (26%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 240/11,815 caps (2.0%))
