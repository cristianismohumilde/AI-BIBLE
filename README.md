...
> **README gerado automaticamente em: 2026-05-19 13:38 UTC**
...
| Capítulos traduzidos | **395** (3.3%) |
| ETA estimado de processamento | **~18d 7h** |
| Custo estimado restante (Oracle GPU) | **~$658 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 13:38 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 395 traduzidos | 🚀 Em andamento (43%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 395/11,815 caps (3.3%))
