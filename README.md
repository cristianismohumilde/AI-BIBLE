...
> **README gerado automaticamente em: 2026-05-19 08:06 UTC**
...
| Capítulos traduzidos | **255** (2.2%) |
| ETA estimado de processamento | **~18d 12h** |
| Custo estimado restante (Oracle GPU) | **~$666 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 08:06 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 255 traduzidos | 🚀 Em andamento (27%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 255/11,815 caps (2.2%))
