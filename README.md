...
> **README gerado automaticamente em: 2026-05-19 13:59 UTC**
...
| Capítulos traduzidos | **411** (3.5%) |
| ETA estimado de processamento | **~18d 6h** |
| Custo estimado restante (Oracle GPU) | **~$657 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 13:59 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 411 traduzidos | 🚀 Em andamento (44%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 411/11,815 caps (3.5%))
