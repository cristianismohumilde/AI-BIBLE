...
> **README gerado automaticamente em: 2026-05-21 10:55 UTC**
...
| Capítulos traduzidos | **1,767** (46.2%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$118 USD** |
| ETA estimado de processamento | **~3d 7h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-21 10:55 UTC |
...
| 📖 Peshitta Siríaca | Siríaco Clássico | 260 caps | 35 traduzidos | 🚀 Em andamento (13%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,767/3,826 caps (46.2%))
