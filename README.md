...
> **README gerado automaticamente em: 2026-05-20 02:04 UTC**
...
| Capítulos traduzidos | **782** (15.7%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$242 USD** |
| ETA estimado de processamento | **~6d 17h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 02:04 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 782 traduzidos | 🚀 Em andamento (84%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 782/4,990 caps (15.7%))
