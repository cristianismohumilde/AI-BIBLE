...
> **README gerado automaticamente em: 2026-05-20 10:54 UTC**
...
| Métrica | Valor |
|---|---|
| Capítulos fonte disponíveis | **4,957** |
| Capítulos traduzidos | **928** (18.7%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$232 USD** |
| ETA estimado de processamento | **~6d 10h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 10:54 UTC |
...
| 🏛️ Septuaginta (LXX) | Grego Clássico | 389 caps | 0 traduzidos | ⏳ Aguardando tradução |
...
### 🚀 Fase 2 — Tradução (Em andamento — 928/4,957 caps (18.7%))
