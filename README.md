...
> **README gerado automaticamente em: 2026-05-19 03:19 UTC**
...
| Capítulos traduzidos | **134** (2.3%) |
| ETA estimado de processamento | **~16d 2h** |
| Custo estimado restante (Oracle GPU) | **~$386 USD** |
| Velocidade (com Double-Pass) | ~15 caps/hora |
| Última atualização | 2026-05-19 03:19 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 134 traduzidos | 🚀 Em andamento (14%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 134/5,924 caps (2.3%))
