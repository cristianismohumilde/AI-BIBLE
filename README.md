...
> **README gerado automaticamente em: 2026-05-19 01:43 UTC**
...
| Capítulos traduzidos | **101** (1.7%) |
| ETA estimado de processamento | **~16d 4h** |
| Custo estimado restante (Oracle GPU) | **~$388 USD** |
| Velocidade (com Double-Pass) | ~15 caps/hora |
| Última atualização | 2026-05-19 01:43 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 101 traduzidos | 🚀 Em andamento (11%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 101/5,924 caps (1.7%))
