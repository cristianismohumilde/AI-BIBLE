...
> **README gerado automaticamente em: 2026-05-20 03:15 UTC**
...
| Capítulos traduzidos | **852** (17.1%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$238 USD** |
| ETA estimado de processamento | **~6d 15h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 03:15 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 852 traduzidos | 🚀 Em andamento (92%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 852/4,990 caps (17.1%))
