...
> **README gerado automaticamente em: 2026-05-19 09:42 UTC**
...
| Capítulos traduzidos | **296** (2.5%) |
| ETA estimado de processamento | **~18d 11h** |
| Custo estimado restante (Oracle GPU) | **~$664 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 09:42 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 296 traduzidos | 🚀 Em andamento (32%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 296/11,815 caps (2.5%))
