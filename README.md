...
> **README gerado automaticamente em: 2026-05-21 15:13 UTC**
...
| Capítulos traduzidos | **1,853** (48.4%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$113 USD** |
| ETA estimado de processamento | **~3d 3h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-21 15:13 UTC |
...
| 📖 Peshitta Siríaca | Siríaco Clássico | 260 caps | 121 traduzidos | 🚀 Em andamento (47%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,853/3,826 caps (48.4%))
