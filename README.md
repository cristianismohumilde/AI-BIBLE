...
> **README gerado automaticamente em: 2026-05-22 09:18 UTC**
...
| Capítulos traduzidos | **2,322** (60.7%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$86 USD** |
| ETA estimado de processamento | **~2d 9h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-22 09:18 UTC |
...
| 🏔️ Armênio Oriental | Armênio Clássico | 260 caps | 70 traduzidos | 🚀 Em andamento (27%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 2,322/3,826 caps (60.7%))
