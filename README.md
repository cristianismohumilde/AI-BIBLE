...
> **README gerado automaticamente em: 2026-05-19 01:58 UTC**
...
| Capítulos traduzidos | **107** (1.8%) |
| ETA estimado de processamento | **~16d 3h** |
| Custo estimado restante (Oracle GPU) | **~$387 USD** |
| Velocidade (com Double-Pass) | ~15 caps/hora |
| Última atualização | 2026-05-19 01:58 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 107 traduzidos | 🚀 Em andamento (12%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 107/5,924 caps (1.8%))
