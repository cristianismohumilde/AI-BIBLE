...
> **README gerado automaticamente em: 2026-05-20 20:48 UTC**
...
| Capítulos traduzidos | **1,354** (35.9%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$139 USD** |
| ETA estimado de processamento | **~3d 20h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 20:48 UTC |
...
| 🇪🇹 Ge'ez (Etiópico) | Ge'ez Clássico | 296 caps | 37 traduzidos | 🚀 Em andamento (12%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,354/3,768 caps (35.9%))
