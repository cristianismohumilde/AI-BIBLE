...
> **README gerado automaticamente em: 2026-05-21 00:45 UTC**
...
| Capítulos traduzidos | **1,470** (39.0%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$132 USD** |
| ETA estimado de processamento | **~3d 16h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-21 00:45 UTC |
...
| 🇪🇹 Ge'ez (Etiópico) | Ge'ez Clássico | 296 caps | 153 traduzidos | 🚀 Em andamento (52%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,470/3,768 caps (39.0%))
