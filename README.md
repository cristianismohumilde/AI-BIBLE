...
> **README gerado automaticamente em: 2026-05-19 12:13 UTC**
...
| Capítulos traduzidos | **361** (3.1%) |
| ETA estimado de processamento | **~18d 8h** |
| Custo estimado restante (Oracle GPU) | **~$660 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 12:13 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 361 traduzidos | 🚀 Em andamento (39%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 361/11,815 caps (3.1%))
