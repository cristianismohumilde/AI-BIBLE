...
> **README gerado automaticamente em: 2026-05-19 06:15 UTC**
...
| Capítulos traduzidos | **198** (1.7%) |
| ETA estimado de processamento | **~18d 14h** |
| Custo estimado restante (Oracle GPU) | **~$670 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 06:15 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 198 traduzidos | 🚀 Em andamento (21%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 198/11,815 caps (1.7%))
