...
> **README gerado automaticamente em: 2026-05-19 09:01 UTC**
...
| Capítulos traduzidos | **277** (2.3%) |
| ETA estimado de processamento | **~18d 11h** |
| Custo estimado restante (Oracle GPU) | **~$665 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 09:01 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 277 traduzidos | 🚀 Em andamento (30%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 277/11,815 caps (2.3%))
