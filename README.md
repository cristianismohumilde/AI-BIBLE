...
> **README gerado automaticamente em: 2026-05-19 04:09 UTC**
...
| Capítulos traduzidos | **149** (2.5%) |
| ETA estimado de processamento | **~16d 1h** |
| Custo estimado restante (Oracle GPU) | **~$385 USD** |
| Velocidade (com Double-Pass) | ~15 caps/hora |
| Última atualização | 2026-05-19 04:09 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 149 traduzidos | 🚀 Em andamento (16%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 149/5,924 caps (2.5%))
