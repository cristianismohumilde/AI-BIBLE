...
> **README gerado automaticamente em: 2026-05-19 13:08 UTC**
...
| Capítulos traduzidos | **382** (3.2%) |
| ETA estimado de processamento | **~18d 7h** |
| Custo estimado restante (Oracle GPU) | **~$659 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 13:08 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 382 traduzidos | 🚀 Em andamento (41%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 382/11,815 caps (3.2%))
