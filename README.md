...
> **README gerado automaticamente em: 2026-05-22 10:19 UTC**
...
| Capítulos traduzidos | **2,357** (61.6%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$84 USD** |
| ETA estimado de processamento | **~2d 8h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-22 10:19 UTC |
...
| 🪨 Manuscritos do Mar Morto | Hebraico/Aramaico Antigo | 986 caps | 85 traduzidos | 🚀 Em andamento (9%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 2,357/3,826 caps (61.6%))
