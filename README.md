...
> **README gerado automaticamente em: 2026-05-22 10:24 UTC**
...
| Capítulos traduzidos | **2,374** (62.0%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$83 USD** |
| ETA estimado de processamento | **~2d 7h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-22 10:24 UTC |
...
| 🪨 Manuscritos do Mar Morto | Hebraico/Aramaico Antigo | 986 caps | 102 traduzidos | 🚀 Em andamento (10%) |
...
| 🏔️ Armênio Oriental | Armênio Clássico | 260 caps | 89 traduzidos | 🚀 Em andamento (34%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 2,374/3,826 caps (62.0%))
