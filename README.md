...
> **README gerado automaticamente em: 2026-05-21 01:41 UTC**
...
| Capítulos traduzidos | **1,502** (39.9%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$130 USD** |
| ETA estimado de processamento | **~3d 15h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-21 01:41 UTC |
...
| 🇪🇹 Ge'ez (Etiópico) | Ge'ez Clássico | 296 caps | 185 traduzidos | 🚀 Em andamento (62%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,502/3,768 caps (39.9%))
