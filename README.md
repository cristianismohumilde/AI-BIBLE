...
> **README gerado automaticamente em: 2026-05-21 11:56 UTC**
...
| Capítulos traduzidos | **1,784** (46.6%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$117 USD** |
| ETA estimado de processamento | **~3d 6h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-21 11:56 UTC |
...
| 📖 Peshitta Siríaca | Siríaco Clássico | 260 caps | 52 traduzidos | 🚀 Em andamento (20%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,784/3,826 caps (46.6%))
