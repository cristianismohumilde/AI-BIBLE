...
> **README gerado automaticamente em: 2026-05-19 04:54 UTC**
...
| Métrica | Valor |
|---|---|
| Capítulos fonte disponíveis | **10,626** |
| Capítulos traduzidos | **165** (1.6%) |
| ETA estimado de processamento | **~16d 18h** |
| Custo estimado restante (Oracle GPU) | **~$603 USD** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-19 04:54 UTC |
...
|:---|:---|---:|---:|:---|
| 📜 Códice de Aleppo | Hebraico Massorético Antigo | 928 caps | 165 traduzidos | 🚀 Em andamento (18%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 165/10,626 caps (1.6%))
