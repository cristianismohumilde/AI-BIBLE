...
> **README gerado automaticamente em: 2026-05-20 23:20 UTC**
...
| Capítulos traduzidos | **1,428** (37.9%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$135 USD** |
| ETA estimado de processamento | **~3d 18h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-20 23:20 UTC |
...
| 🇪🇹 Ge'ez (Etiópico) | Ge'ez Clássico | 296 caps | 111 traduzidos | 🚀 Em andamento (38%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,428/3,768 caps (37.9%))
