...
> **README gerado automaticamente em: 2026-05-21 14:48 UTC**
...
| Capítulos traduzidos | **1,842** (48.1%) |
| Orçamento Disponível (Oracle GPU) | **$300 USD** (~R$ 1.500) |
| Custo estimado restante | **~$114 USD** |
| ETA estimado de processamento | **~3d 4h** |
| Velocidade (com Double-Pass) | ~26 caps/hora |
| Última atualização | 2026-05-21 14:48 UTC |
...
| 📖 Peshitta Siríaca | Siríaco Clássico | 260 caps | 110 traduzidos | 🚀 Em andamento (42%) |
...
### 🚀 Fase 2 — Tradução (Em andamento — 1,842/3,826 caps (48.1%))
