...
> Gerado dinamicamente em: **2026-05-21 07:18 UTC**
...
| **1** | **Targum Onkelos (Gênesis)** | Aramaico Antigo | **🚀 Traduzindo (49/50 caps)** | `output/Targum_Onkelos/` | Rodando ativamente na VM (Gênesis priorizado). |
...
**Progresso geral:** 0/1662 arquivos transliterados.
