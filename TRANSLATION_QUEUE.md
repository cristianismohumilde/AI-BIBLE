...
> Gerado dinamicamente em: **2026-05-21 07:08 UTC**
...
| **1** | **Targum Onkelos (Gênesis)** | Aramaico Antigo | **🚀 Traduzindo (45/50 caps)** | `output/Targum_Onkelos/` | Rodando ativamente na VM (Gênesis priorizado). |
...
**Progresso geral:** 0/1658 arquivos transliterados.
