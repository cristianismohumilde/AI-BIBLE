...
> Gerado dinamicamente em: **2026-05-21 05:53 UTC**
...
| **1** | **Targum Onkelos (Gênesis)** | Aramaico Antigo | **🚀 Traduzindo (19/50 caps)** | `output/Targum_Onkelos/` | Rodando ativamente na VM (Gênesis priorizado). |
...
**Progresso geral:** 0/1632 arquivos transliterados.
