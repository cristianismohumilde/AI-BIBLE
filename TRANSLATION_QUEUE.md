...
> Gerado dinamicamente em: **2026-05-22 22:37 UTC**
...
| :--- | :--- | :---: |
| SBL Hebraico (ā, ē, ō, š, ṣ, ṭ, ḥ, ʿ, ʾ) | Aleppo, DSS, Targum Onkelos | **🔤 Transliterando (3/2406 arquivos)** |
| SBL Grego Koiné (ex: Κύριος → Kyrios) | LXX, BYZ | **🔤 Transliterando (3/2406 arquivos)** |
| CAL Aramaico (ex: Sedra/CAL) | Targum Onkelos, Peshitta Siríaca | **🔤 Transliterando (3/2406 arquivos)** |
| Etíope padrão (ex: አምላክ → ʾAmlāk) | Ge'ez | **🔤 Transliterando (3/2406 arquivos)** |
| Copta acadêmico (ex: ⲡⲛⲉⲩⲙⲁ → pneuma) | Coptic Sahidic | **🔤 Transliterando (3/2406 arquivos)** |
| ISO 9985 Armênio | Armenian Eastern | **🔤 Transliterando (3/2406 arquivos)** |

**Progresso geral:** 3/2406 arquivos transliterados.
