...
> Gerado dinamicamente em: **2026-05-21 07:13 UTC**
...
| **1** | **Targum Onkelos (Gênesis)** | Aramaico Antigo | **🚀 Traduzindo (47/50 caps)** | `output/Targum_Onkelos/` | Rodando ativamente na VM (Gênesis priorizado). |
...
**Progresso geral:** 0/1660 arquivos transliterados.
