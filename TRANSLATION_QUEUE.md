...
> Gerado dinamicamente em: **2026-05-21 05:27 UTC**
...
| **1** | **Targum Onkelos (Gênesis)** | Aramaico Antigo | **🚀 Traduzindo (7/50 caps)** | `output/Targum_Onkelos/` | Rodando ativamente na VM (Gênesis priorizado). |
