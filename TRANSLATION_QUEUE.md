...
> Gerado dinamicamente em: **2026-05-21 18:25 UTC**
...
| **2** | **Manuscritos do Mar Morto (DSS)** | Hebraico/Aramaico de Qumran | **🚀 Traduzindo (69/127 caps)** | `data/DSS/` | 5 rolos prioritários: 1QIsa-a, 1QpHab, 1QS, 1QM, 1QH. |
...
| **5** | **Peshitta Siríaca** | Siríaco Clássico | **🚀 Traduzindo (236/260 caps)** | `data/ancient_versions/` | Novo Testamento Siríaco. |
...
**Progresso geral:** 0/1968 arquivos transliterados.
