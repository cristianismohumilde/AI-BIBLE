...
> Gerado dinamicamente em: **2026-05-21 06:48 UTC**
...
| **1** | **Targum Onkelos (Gênesis)** | Aramaico Antigo | **🚀 Traduzindo (39/50 caps)** | `output/Targum_Onkelos/` | Rodando ativamente na VM (Gênesis priorizado). |
...
**Progresso geral:** 0/1652 arquivos transliterados.
